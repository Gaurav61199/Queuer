...
public class FormActivity2 extends AppCompatActivity implements FFragment.CommBridge{
    ...
    public void clinicPlaceName(String Clinic, String Place) {
        ...
        getFragmentManager().beginTransaction().setCustomAnimations(R.animator.frag_slide_in, R.animator.frag_slide_out, R.animator.frag_pop_out, R.animator.frag_pop_in).replace(R.id.fragment_container, mSFragment).addToBackStack(null).commit();
